...
相应的，如果某个点$Q$满足$QF_1+QF_2<2a$，称点在椭圆的\emph{内部}，不等式如果是大于，则点在椭圆的\emph{外部}。
...
\begin{proof}[证明]
  如图\ref{fig:oval-chord-located-in-oval}，$AB$是椭圆的一条弦，点$P$是这弦上异于端点的任意一点，根据我们在例\ref{example:ptolemy-inequality-for-triangle}中所证的不等式，有
  \begin{eqnarray*}
