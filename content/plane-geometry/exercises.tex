...
\label{exercise:2016-06-24-1}
  (姚佳斌供题)如图，在三角形$ABC$中，$AO$是$BC$边上的高，$D$是$AO$的中点，点$E$是其内切圆$\odot I$与$BC$边的切点，连接$ED$并延长与内切圆相交于另一点$F$，过点$C$并与$BC$垂直的直线与$BI$的延长线相交于$G$，求证:(1) $EF \perp FG$,(2)$EF$平分角$BFC$。
\end{exercise}
...
\begin{exercise}
 如\autoref{fig:exercise-ahk-coline}，在$\triangle ABC$中，点$H$是垂心，$AD$是$BC$边上的中线，过$H$作$AD$的垂线，分别与$AC$、$AB$边相交于$E$、$F$，连结$BE$、$CF$相交于点$K$，求证 $A$、$H$、$K$三点共线。
\end{exercise}
