...
\begin{example}[梅涅劳斯定理的推广及三角形内接三角形的最大面积]
...
\begin{proof}[证明]
  ...
  所以最终
  \begin{equation*}
    \frac{S_{\triangle ABZ}}{S_{\triangle ABC}} = \frac{BZ}{BE} \cdot \frac{AE}{AC} = \frac{\lambda_2(1+\lambda_3)}{(1+\lambda_3)(1+\lambda_2+\lambda_2\lambda_3)}
  \end{equation*}
  同样可得另外两式
  \begin{eqnarray*}
    \frac{S_{\triangle BCX}}{S_{\triangle ABC}} & = & \frac{\lambda_3(1+\lambda_1)}{(1+\lambda_1)(1+\lambda_3+\lambda_3\lambda_1)} \\
    \frac{S_{\triangle CAY}}{S_{\triangle ABC}} & = & \frac{\lambda_1(1+\lambda_2)}{(1+\lambda_2)(1+\lambda_1+\lambda_1\lambda_2)} 
  \end{eqnarray*}
  由此三式即可得结论。
\end{proof}
